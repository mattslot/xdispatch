...
#if _MSC_VER >= 1900
 # define XDISPATCH_COMPILER_MSVC2015 1
 # define XDISPATCH_COMPILER "Visual Studio 2015"
#elif _MSC_VER >= 1600
...
// detect enabled featureset
 ...
 # elif defined __GLIBCXX__
  ...
  #  define XDISPATCH_STL_MSSTL 1
  #  define XDISPATCH_STL "Microsoft STL"
 ...
 # if XDISPATCH_COMPILER_MSVC2015
  #  define XDISPATCH_CPP11 1
 ...
 # elif XDISPATCH_CPP11 && __GLIBCXX__ >= 20120322
  ...
  #  define XDISPATCH_CPP11_MEMORY 1
  #  define XDISPATCH_CPP11_FUNCTIONAL 1
 # elif XDISPATCH_STL_MSSTL && XDISPATCH_CPP11
  #  define XDISPATCH_CPP11_TYPE_TRAITS 1
  #  define XDISPATCH_CPP11_MEMORY 1
  #  define XDISPATCH_CPP11_FUNCTIONAL 1
